package com.project.QuickProject.monitor.service;

import com.project.QuickProject.monitor.config.JmxConnectorInstance;
import com.project.QuickProject.monitor.dto.*;
import com.project.QuickProject.monitor.dto.ThreadInfo;
import com.project.QuickProject.monitor.utils.EntryUtil;
        ...
        }catch (Exception e)
        {
            try {
                ...
                for (int i=0;i<jvms.size();i++)
                {
                    ...
                    {
                        String address = ConnectorAddressLink.importFrom(jvms.get(i).getPid());
